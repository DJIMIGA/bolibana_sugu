...
import { logoutAsync, updateProfileAsync, fetchProfileAsync, fetchLoyaltyInfoAsync, clearError } from '../store/slices/authSlice';
import { useNavigation } from '@react-navigation/native';
import { COLORS, STORAGE_KEYS, BRAND } from '../utils/constants';
  ...
  if ((token || isAuthenticated || hasTokenInStorage) && !error) {
    ...
    return (
      <ScrollView
        ...
        contentContainerStyle={[styles.notLoggedInContainer, { paddingBottom: insets.bottom + 24, paddingTop: insets.top + 16 }]}
        showsVerticalScrollIndicator={false}
      >
        <View style={styles.notLoggedInContent}>
          <View style={styles.logoContainer}>
            <Logo variant="full" dimension={55} showText={false} />
          </View>
          <Text style={styles.notLoggedInTitle}>Bienvenue sur BoliBana SuGu</Text>
          <Text style={styles.notLoggedInSubtitle}>
            Votre intermédiaire expert du marché. Créez un compte gratuit et accédez à des milliers de produits.
          </Text>

          <View style={styles.benefitsContainer}>
            <View style={styles.benefitItem}>
              <Ionicons name="bag-check-outline" size={22} color={COLORS.PRIMARY} />
              <Text style={styles.benefitText}>Commandez en toute simplicité</Text>
            </View>
            <View style={styles.benefitItem}>
              <Ionicons name="trophy-outline" size={22} color={COLORS.PRIMARY} />
              <Text style={styles.benefitText}>Programme de fidélité & points cadeaux</Text>
            </View>
            <View style={styles.benefitItem}>
              <Ionicons name="location-outline" size={22} color={COLORS.PRIMARY} />
              <Text style={styles.benefitText}>Suivi de commandes en temps réel</Text>
            </View>
            <View style={styles.benefitItem}>
              <Ionicons name="pricetag-outline" size={22} color={COLORS.PRIMARY} />
              <Text style={styles.benefitText}>Offres exclusives réservées aux membres</Text>
            </View>
          </View>
