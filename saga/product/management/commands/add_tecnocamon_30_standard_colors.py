...
class Command(BaseCommand):
    help = 'Ajoute les couleurs pour les TECNO CAMON 30 (version non-5G)'

    def handle(self, *args, **options):
        self.stdout.write('🎨 Début de l\'ajout des couleurs TECNO CAMON 30 (non-5G)...')
        ...
        colors_data = [
            ...
            {
                'name': 'Brun Sable Sahara',
                'code': '#d2b48c'  # Brun sable
            }
        ]
        ...
        self.stdout.write('✅ Ajout des couleurs TECNO CAMON 30 (non-5G) terminé !')
        self.stdout.write('')
        self.stdout.write('📝 Note: Vous pouvez maintenant exécuter la commande d\'ajout des téléphones CAMON 30 (non-5G)') 