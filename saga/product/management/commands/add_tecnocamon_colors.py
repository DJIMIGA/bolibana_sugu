...
class Command(BaseCommand):
    help = 'Ajoute les couleurs officielles du TECNO CAMON 40 Premier 5G'

    def handle(self, *args, **options):
        colors_data = [
            {'name': 'Noir Galaxy', 'code': '#000000', 'description': 'Couleur officielle TECNO CAMON 40 Premier 5G - Noir Galaxy élégant'},
            {'name': 'Vert Émeraude', 'code': '#00a86b', 'description': 'Couleur officielle TECNO CAMON 40 Premier 5G - Vert Émeraude moderne'}
        ]
